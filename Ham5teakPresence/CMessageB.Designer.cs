namespace Ham5teakPresence
{
    partial class CMessageB
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(CMessageB));
            ...
            this.label1.Text = "The presence should be looking like the image seen above";
            ...
            this.label2.Text = "Make sure to have game activity enabled from\r\ndiscord settings before applying th" +
    "e presence!";
            // 
            // button1
            // 
            ...
            this.ShowIcon = false;
            this.Text = "Help";
            this.Load += new System.EventHandler(this.CMessageB_Load);
